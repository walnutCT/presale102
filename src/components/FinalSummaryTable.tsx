    ...
    return (
      <div className="bg-white border border-slate-200 rounded-lg p-10 text-center shadow-sm">
        <div className="flex flex-col items-center justify-center gap-2 max-w-md mx-auto">
          ...
          <h3 className="font-bold text-slate-800 text-base mt-2">ยังไม่มีการบันทึกข้อมูลสรุป (Final)</h3>
          <p className="text-slate-400 text-xs leading-relaxed">
            กรุณาคำนวณปรับยอดตามสูตร หรือตั้งค่าจำนวนบวกเพิ่มเติมในตารางหลักด้านบน แล้วคลิกปุ่ม <span className="font-bold text-[#ba191a] underline">"บันทึกการทำงาน Presale"</span> เพื่อส่งตารางสรุปแผนงานขั้นสุดท้ายนี้
          </p>
        </div>
      </div>
    );
      ...
      <div className="p-4 bg-gradient-to-r from-emerald-50 to-white border-b border-rose-100 flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          ...
          <h2 className="font-extrabold text-[#ba191a] text-base uppercase tracking-tight">
            ตารางสรุปการทำงานPresale (Final)
          </h2>
        </div>
        ...
        <table className="w-full text-left border-collapse">
          ...
          <tfoot>
            <tr className="border-t-2 border-slate-200 bg-emerald-50/30 font-bold text-slate-800 text-xs uppercase">
              ...
              <td className="p-3.5 text-center text-emerald-800">TOTAL</td>
              <td className="p-3.5 text-slate-400 text-[10px] font-normal">ยืนยันและล็อคผลลัพธ์การสับบอร์ดแล้ว</td>
